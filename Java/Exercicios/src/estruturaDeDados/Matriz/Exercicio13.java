...
public class Exercicio13 {
    public static void main(String[] args) {
        ...
        printMatriz(matriz2);
        jumpLine();
        System.out.println("Matriz intesecção: ");
        printMatriz(interseccaoMatriz(matriz1, matriz2));
    ...
    public static int [][] interseccaoMatriz (int [][] matriz1, int [][] matriz2) {
        int matrizInterseccao [][] = new int[matriz1.length][matriz1.length];
        ...
        for (int i = 0; i < matriz2.length; i++)
            for (int j = 0; j < matriz2[0].length; j++) {
                ...
                if (verificaSeValorExiste(matriz1, numero)){
                    matrizInterseccao [i][j] = matriz2 [i][j];
                }
                else {
                    matrizInterseccao[i] [j] = 0;
                }
            }
